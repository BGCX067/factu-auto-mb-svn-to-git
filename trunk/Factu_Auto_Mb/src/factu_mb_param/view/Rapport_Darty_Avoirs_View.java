...
public class Rapport_Darty_Avoirs_View extends JFrame{	
	/**
	 * 
	 */
	...
	public Rapport_Darty_Avoirs_View(){					
		...
		lbTitle = new JLabel("Début génération avoir");
		...
		//Modif fichier AAE DARTY frais de résiliation.xls
		GridBagConstraints gridBagConstraintsTmpFile = new GridBagConstraints();
		lbTempFile = new JLabel("Recuperation des données 'AAE DARTY frais de résiliation.xls'");
        ...
        gridBagConstraintsEquiv1.insets = new Insets(4, -20, 4, 2);
        ...
        gridBagConstraintsTmpFileRes.insets = new Insets(4, 0, 4, 2);
        ...
        //Modification onglet 1 - Frais de résiliation DSL
      	GridBagConstraints gridBagConstraintsTempFile = new GridBagConstraints();
      	lbInput = new JLabel("Mise à jour onglet '1 - Frais de résiliation DSL'");
        ...
        gridBagConstraintsEquiv2.insets = new Insets(4, -20, 4, 2);
        ...
        gridBagConstraintsTempFileRes.insets = new Insets(4, 0, 4, 2);
        ...
        //Mise a jour des données ancien abo
      	GridBagConstraints gridBagConstraintsAbo = new GridBagConstraints();
      	lbAboFile = new JLabel("Mise à jour onglet '2 - Ancien abo 2P THD'");
        ...
        gridBagConstraintsEquiv3.insets = new Insets(4, -20, 4, 2);
        ...
        gridBagConstraintsAboRes.gridx = 3;
  		...
  		gridBagConstraintsAboRes.insets = new Insets(4, 0, 4, 2);
      ...
      //Mise a jour des données nouvel abo
        GridBagConstraints gridBagConstraintsFas = new GridBagConstraints();
      	lbFASFile = new JLabel("Mise à jour onglet '3 - Nouvel abo 2P THD'");
        ...
        gridBagConstraintsEquiv4.insets = new Insets(4, -20, 4, 2);
        ...
        gridBagConstraintsFasRes.gridx = 3;
  		...
  		gridBagConstraintsFasRes.insets = new Insets(4, 0, 4, 2);
        ...
        GridBagConstraints gridBagConstraintsRecap = new GridBagConstraints();
      	lbRecapFile = new JLabel("Mise à jour de l'onglet 'Recap avoirs'");
        ...
        gridBagConstraintsEquiv6.insets = new Insets(4, -20, 4, 2);
        ...
        gridBagConstraintsRecapRes.insets = new Insets(4, 0, 4, 2);
	...
	public JTextArea remarqueSuccess(String fileName,String chemin){
		rqSuccess= new JTextArea("Note :\nL'avoir "+fileName+"\na été généré avec succès dans le " +
		"repertoire :\n'"+chemin+"'.\nVeuillez vérifier les résultats");
