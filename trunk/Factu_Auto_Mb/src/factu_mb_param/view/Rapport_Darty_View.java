...
public class Rapport_Darty_View extends JFrame{	
	/**
	 * 
	 */
	...
	public Rapport_Darty_View(){					
		...
		lbTempFile = new JLabel("Modification fichier TEMP 'DRT_INFOS_FACTU'");
        ...
        GridBagConstraints gridBagConstraintsFas = new GridBagConstraints();
      	lbFASFile = new JLabel("Mise à jour des données 'FAS'");
